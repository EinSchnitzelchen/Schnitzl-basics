...
--Setting ThreadControls
Config.ThreadControls = { --Basicly the same as Controls but to make things working (will be updated later)
    Crouch = {keyboard = Keys['LEFTCTRL']}
}

Config.Animations = { --You can get Animations here: https://wiki.gtanet.work/index.php?title=Animations
    HandsUp = {
...
Config.ragdolled = true --set to false if you dont want the Character be able to Ragdoll
